...
<template>
    ...
    <el-dialog v-model="dialogVisible" :title="action == 'add' ? '新增用户' : '编辑用户'" width="35%"
        ...
        <!-- 需要注意的是设置了:inline="true",会对el-select的样式造成影响， 通过给他设置一个class=select-clearn在css进行处理 -->
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="出生日期" prop="birth">
                        <el-date-picker format="YYYY-MM-DD" value-format="YYYY-MM-DD" v-model="formUser.birth"
                            type="date" placeholder="请输入" style="width:100%"></el-date-picker>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
